...
\begin{table}[ht]
    \begin{center}
        \begin{tabular}{|c|c|c|c|l|} \hline
            Block & Offset & Address & R/W & Purpose \\\hline\hline
            \verb+$C1+ & \verb+$1000+ & \verb+0x18_3000+ & R/W & Graphics CLUT 0 \\ \hline
            \verb+$C1+ & \verb+$1400+ & \verb+0x18_3400+ & R/W & Graphics CLUT 1 \\ \hline
            \verb+$C1+ & \verb+$1800+ & \verb+0x18_3800+ & R/W & Graphics CLUT 2 \\ \hline
            \verb+$C1+ & \verb+$1C00+ & \verb+0x18_3C00+ & R/W & Graphics CLUT 3 \\ \hline
        \end{tabular}
    \end{center}
...
\begin{table}[ht]
    \begin{center}
        \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|} \hline
            ...
            \verb+0xFFC2+ & R/W & --- & \multicolumn{3}{|c|}{LAYER1} & --- & \multicolumn{3}{|c|}{LAYER0} \\\hline
            \verb+0xFFC3+ & R/W & \multicolumn{5}{|c|}{---} & \multicolumn{3}{|c|}{LAYER2} \\\hline
        \end{tabular}
    \end{center}
